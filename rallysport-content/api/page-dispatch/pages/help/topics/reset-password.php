...
abstract class ResetUserPassword extends \RSC\HTMLPage\Component\HelpTopic
{
    ...
    {
        return "Restoring a lost user account password";
    }

    static public function inner_html() : string
    {
        return "
        <p>If you've lost your account password, you can request a password
        ...
        which you can specify a new account password.
        </p>

        <p>To complete the above form, you'll need to provide the following:
            <ul>
